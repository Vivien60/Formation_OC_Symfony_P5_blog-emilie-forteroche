...
<div class="monitoringArticles adminContent">
    ...
    <div class="monitoring__list commentPaleTable gridList">
        ...
        <div class="gridList--header content"><h3>Vues</h3><div class="gridList--order"><a href="?action=monitorArticles&order=title&dir=1">&#9207;</a>&nbsp;<a href="?action=monitorArticles&order=title&dir=0">&#9206;</a></div></div>
        <div class="gridList--header content"><h3>Commentaires</h3><div class="gridList--order"><a href="?action=monitorArticles&order=title&dir=1">&#9207;</a>&nbsp;<a href="?action=monitorArticles&order=title&dir=0">&#9206;</a></div></div>
        <div class="gridList--header content"><h3>Date de publication</h3><div class="gridList--order"><a href="?action=monitorArticles&order=title&dir=1">&#9207;</a>&nbsp;<a href="?action=monitorArticles&order=title&dir=0">&#9206;</a></div></div>
        <div>&nbsp;</div>
